...
Pack must include: scope block, TRACK, file/plan set, load-bearing claims, plan/todo ids, prior deltas, Freshness notes (or "none"), prepr bundle or N/A, critic reports for full rounds (delta code: bug_hunt only).
